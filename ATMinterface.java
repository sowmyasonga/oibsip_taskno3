...
System.out.println ("---------------------------------");
System.out.
	  println ("Sufficient Balance not available for the withdrawl!");
System.out.println ("---------------------------------");
}
}
...
this.balance -= amount;
acc.balance += amount;
System.out.println ("Account of " + this.customerName +
			     " becomes $" + this.balance);
System.out.println ("Account of " + acc.customerName + " becomes $" +
			     acc.balance);
System.out.println ("\n");
}
}
...
BankAccount bb = new BankAccount ("SRAVYA", "0507");
...
public static void main (String[]args)
  {
BankAccount ba = new BankAccount ("SOWMYA", "2004");
ba.checkId ();
} 
}
